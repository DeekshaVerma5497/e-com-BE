...
public class OrderReturnController {
    ...
    @PostMapping
    public ResponseEntity<OrderReturn> requestReturn(
        ...
        return ResponseEntity.ok(
            svc.requestReturn(userId, orderItemId, reason, refundMethod)
        );
    }
    ...
    public ResponseEntity<List<OrderReturn>> listForOrder(
        @PathVariable String userId,
    ...
    public ResponseEntity<OrderReturn> updateReturn(
        @PathVariable String userId,
