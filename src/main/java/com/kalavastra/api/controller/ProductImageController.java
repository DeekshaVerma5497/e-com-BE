...
public class ProductImageController {
	...
	@GetMapping
	public ResponseEntity<List<ProductImage>> list(@PathVariable Long productId) {
	...
	public ResponseEntity<ProductImage> markPrimary(@PathVariable Long productId, @PathVariable Long imageId) {
